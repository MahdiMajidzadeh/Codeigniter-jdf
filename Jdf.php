...
Convert Jdf to Codeigniter library : Mahdi Majidzadeh<mahdi@majidzadeh.ir>
Base on version 2.70
*/
    ...
    public function jdate($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
    {
        ...
        for ($i = 0; $i < $sl; $i++) {
            ...
            switch ($sub) {
                ...
                case'D':
                $out .= $this->jdate_words(['kh'=>$date[7]], ' ');
                break;
                ...
                case'v':
                $out .= $this->jdate_words(['ss'=>($j_y % 100)], ' ');
                break;
